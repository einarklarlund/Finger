...
// addressing the vector "col" with a for loop iterator variable gave a warning
//      added a big ugly if else statement to get rid of the warning
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                for(int i = 0; i < 3; i++) 
                {
                    ...
                    fixed c = smoothstep(0., .1, .25 + m * .3 - y);
